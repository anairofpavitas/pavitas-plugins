...
Quick save for pattern documents and project progress updates.

## Usage

### Pattern Storage
"Log this pattern" → Save formatted pattern to:
1. Notion Littlebird Log (with appropriate tags)
2. crochet/ folder organized by article type
