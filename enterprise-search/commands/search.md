...
- **Slack/Discord** — chat platform tools
- **Gmail** — email tools
- **Google Drive/Box** — cloud storage tools
- **Notion Tasks** — project tracking tools
- **Notion CRM** — CRM tools
...
Supported sources: Slack/Discord, Gmail, Google Drive/Box, Notion Tasks, Notion CRM, Notion,
...
- **Source hints**: References to specific tools ("in Slack/Discord", "that email", "the doc")
...
**Deduplication:**
- Identify the same information appearing across sources (e.g., a decision discussed in Slack/Discord AND confirmed via email)
...
Sources:
- [Source 1: brief description] (Slack/Discord, #channel, date)
- [Source 2: brief description] (Gmail, from person, date)
- [Source 3: brief description] (Google Drive/Box, doc name, last modified)
```
...
Found across:
- Slack/Discord: X relevant messages in Y channels
- Gmail: X relevant threads
- Google Drive/Box: X related documents
