...
- **Google Drive/Box** — recently modified docs shared with user
- **Notion Tasks** — tasks assigned, completed, commented on
- **Notion CRM** — opportunity updates, account activity
- **Notion** — recently updated wiki pages

If no sources are connected, guide the user:
```
To generate a digest, you'll need at least one source connected.
Check your MCP settings to add Slack/Discord, Gmail, Google Drive/Box, or other tools.
```
...
```
## Project Aurora
- Slack/Discord: Design review thread concluded — team chose Option B (#design, Tuesday)
- Gmail: Sarah sent updated spec incorporating feedback (Wednesday)
- Google Drive/Box: "Aurora API Spec v3" updated by Sarah (Wednesday)
- Notion Tasks: 3 tasks moved to In Progress, 2 completed

## Budget Planning
- Gmail: Finance team requesting Q2 projections by Friday
- Slack/Discord: Todd shared template in #finance (Monday)
- Google Drive/Box: "Q2 Budget Template" shared with you (Monday)
```
...
Sources scanned: Slack/Discord, Gmail, Google Drive/Box, [others]
...
- Deduplicate cross-source activity (same decision in Slack/Discord and email = one entry)
