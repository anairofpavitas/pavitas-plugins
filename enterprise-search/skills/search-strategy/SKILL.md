...
```
Slack/Discord:  "API migration timeline decision" (semantic) + "API migration" in:#engineering after:2025-01-01
Notion: semantic search "API migration timeline decision"
Notion Tasks:  text search "API migration" in relevant workspace
```
...
|-----------|---------|----------|
| **Decision** | "What did we decide about X?" | Prioritize conversations (Slack/Discord, email), look for conclusion signals |
...
**Filter mapping:**
| Enterprise filter | Slack/Discord syntax |
|------------------|--------------|
...
**Filter mapping:**
| Enterprise filter | Notion Tasks parameter |
|------------------|----------------|
...
[User query]
     ↓ decompose
[Slack/Discord query] [Gmail query] [Google Drive/Box query] [Wiki query] [Notion Tasks query]
     ↓            ↓            ↓              ↓            ↓
  (parallel execution)
     ↓
