...
Transform this:
```
Slack/Discord result: "Sarah said in #eng: 'let's go with REST, GraphQL is overkill for our use case'"
Gmail result: "Subject: API Decision — Sarah's email confirming REST approach with rationale"
Google Drive/Box result: "API Design Doc v3 — updated section 2 to reflect REST decision"
Notion Tasks result: "Task: Finalize API approach — marked complete by Sarah"
```
...
been updated to reflect the decision. The related Notion Tasks task is marked complete.

Sources:
- Slack/Discord: #engineering thread (Jan 14)
- Gmail: "API Decision" from Sarah (Jan 15)
- Google Drive/Box: "API Design Doc v3" (updated Jan 15)
- Notion Tasks: "Finalize API approach" (completed Jan 15)
```
...
- One source references another ("as discussed in Slack/Discord", "per the email", "see the doc")
...
The design doc was updated to reflect this (Google Drive/Box: "API Design Doc v3").
```

Source list at the end for completeness:
```
Sources:
- Slack/Discord: #engineering discussion (Jan 14) — initial decision thread
- Gmail: "API Decision" from Sarah Chen (Jan 15) — formal confirmation
- Google Drive/Box: "API Design Doc v3" last modified Jan 15 — updated specification
```

### Attribution Rules

- Always name the source type (Slack/Discord, Gmail, Google Drive/Box, etc.)
...
- For Slack/Discord, note the channel name
- For Gmail, note the subject line and sender
- For Google Drive/Box, note the document title
...
in Slack/Discord, but I couldn't find a formal decision document. The information
...
- The Slack/Discord discussion on Jan 10 suggested GraphQL
...
but the earlier Slack/Discord discussion explored GraphQL first.
```
...
**Do not:**
- List results source by source ("From Slack/Discord: ... From Gmail: ... From Google Drive/Box: ...")
